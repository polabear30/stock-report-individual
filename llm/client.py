...
def _mock(context: Dict[str, Any], ticker_type: str) -> Dict[str, Any]:
    ...
    base = {
        ...
        "headline_metrics": {
            "rsi_daily_label": "중립" if (d.get("rsi") or 50) < 70 else "과매수", "rsi_daily_dir": "warn",
            "rsi_intraday_label": "조정권", "rsi_intraday_dir": "warn",
            "macd_daily_label": "약세 전환", "macd_daily_dir": "bear",
            "score_note": "AI 산출(모의)", "score_dir": "warn",
            "entry_zone": f"${round(price*0.93,1)}~{round(price*0.97,1)}",
            "exit_zone": f"${tgt or round(price*1.2,1)}"},
        "daily": {"ma_short": {"text": "정배열(모의)", "dir": "bull"}, "ma_mid": {"text": "돌파(모의)", "dir": "bull"},
                  "ma_long": {"text": "하방(모의)", "dir": "bear"}, "rsi": {"text": "중립(모의)", "dir": "warn"},
                  "macd": {"text": "약세 전환(모의)", "dir": "bear"}, "bollinger": {"text": "하단 근접(모의)", "dir": "warn"},
                  "resistance": {"text": "저항 $X(모의)", "dir": "warn"}, "summary": "일봉 종합(모의)"},
        "intraday": {"info": "120분봉 모의 도입부.", "summary": "통합 판단(모의)",
                     "rows": {"ma": {"val": "정배열(모의)", "dir": "bull", "sig": "단기 우상향"},
                              "rsi": {"val": "과매도(모의)", "dir": "warn", "sig": "반등 대기"},
                              "stoch": {"val": "저점(모의)", "dir": "warn", "sig": "모의"},
                              "bollinger": {"val": "하단(모의)", "dir": "bear", "sig": "모의"},
                              "volume": {"val": "감소(모의)", "dir": "warn", "sig": "모의"},
                              "macd": {"val": "약세(모의)", "dir": "bear", "sig": "모의"}},
        ...
        "waves": [{"num": "1파", "range": "모의", "desc": "저점 반등", "current": False},
                  ...
                  {"num": "3파", "range": "모의", "desc": "상승", "current": False},
                  {"num": "4파 현재", "range": "모의", "desc": "조정 진행중", "current": True}],
