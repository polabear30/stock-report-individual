...
def default_analysis() -> Dict[str, Any]:
    return {
        ...
        "daily": {
            "ma_short": {"text": "", "dir": "warn"}, "ma_mid": {"text": "", "dir": "warn"},
            "ma_long": {"text": "", "dir": "warn"}, "rsi": {"text": "", "dir": "warn"},
            "macd": {"text": "", "dir": "warn"}, "bollinger": {"text": "", "dir": "warn"},
            "resistance": {"text": "", "dir": "warn"}, "summary": "",
        },
        "intraday": {"info": "", "summary": "",
                     "rows": {"ma": {"val": "", "dir": "warn", "sig": ""}, "rsi": {"val": "", "dir": "warn", "sig": ""},
                              "stoch": {"val": "", "dir": "warn", "sig": ""}, "bollinger": {"val": "", "dir": "warn", "sig": ""},
                              "volume": {"val": "", "dir": "warn", "sig": ""}, "macd": {"val": "", "dir": "warn", "sig": ""}},
...
JSON_SHAPE = """{
  ...
  "daily": {"ma_short": {"text":"5·20일 이평 해석","dir":"bull|warn|bear"}, "ma_mid": {"text":"100일","dir":"..."},
            ...
            "resistance": {"text":"핵심 저항/지지","dir":"warn"}, "summary": "일봉 종합 한 줄"},
  "intraday": {"info": "120분봉 도입 설명 1~2문장", "summary": "통합 판단 한 줄",
               "rows": {"ma":{"val":"신호 요약(예: 완전 정배열)","dir":"bull|warn|bear","sig":"부연 설명"},
                        "rsi":{"val":"예: 과매수","dir":"bear","sig":"설명"}, "stoch":{"val":"","dir":"","sig":""},
                        "bollinger":{"val":"","dir":"","sig":""}, "volume":{"val":"","dir":"","sig":""}, "macd":{"val":"","dir":"","sig":""}},
